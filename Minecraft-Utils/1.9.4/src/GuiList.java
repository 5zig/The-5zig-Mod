...
public class GuiList<E extends Row> extends bdo implements IGuiList<E> {
	...
	public void a(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.q) {
			...
			bnf.g();
			bnf.p();
			bnr tesselator = bnr.a();
			bmx worldRenderer = tesselator.c();
			...
			if (backgroundTexture != null) {
				...
				MinecraftFactory.getVars().bindTexture(bcs.b);
				float var7 = 32.0F;
				worldRenderer.a(7, bvm.i);
	...
	protected void a(int x, int y, bnr tesselator) {
		if (header != null) {
