...
public class GuiHandle extends bez implements IGuiHandle {
	...
	public static void drawRect(double left, double top, double right, double bottom, int color) {
		...
		bnr worldRenderer = bnr.a();
		bmx tesselator = worldRenderer.c();
		GLUtil.enableBlend();
		bnf.z();
		GLUtil.tryBlendFuncSeparate(770, 771, 1, 0);
		GLUtil.color(b, g, r, a);
		tesselator.a(7, bvm.e);
