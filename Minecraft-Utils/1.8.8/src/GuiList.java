...
public class GuiList<E extends Row> extends awi implements IGuiList<E> {
	...
	public void a(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.q) {
			...
			if (backgroundTexture != null) {
				...
				float var7 = 32.0F;
				var6.a(7, bms.i);
				var6.b((double) this.g, (double) this.e, 0.0D).a((double) ((float) this.g / var7), (double) ((float) (this.e + (int) this.n) / var7)).b(32, 32, 32, 255).d();
				var6.b((double) this.f, (double) this.e, 0.0D).a((double) ((float) this.f / var7), (double) ((float) (this.e + (int) this.n) / var7)).b(32, 32, 32, 255).d();
				var6.b((double) this.f, (double) this.d, 0.0D).a((double) ((float) this.f / var7), (double) ((float) (this.d + (int) this.n) / var7)).b(32, 32, 32, 255).d();
				var6.b((double) this.g, (double) this.d, 0.0D).a((double) ((float) this.g / var7), (double) ((float) (this.d + (int) this.n) / var7)).b(32, 32, 32, 255).d();
				var5.b();
			}
			...
			if (drawDefaultBackground || MinecraftFactory.getVars().isPlayerNull() || var11 > 0) {
				var6.a(7, bms.i);
				var6.b((double) this.g, (double) (this.d + var10), 0.0D).a(0.0D, 1.0D).b(0, 0, 0, 0).d();
				var6.b((double) this.f, (double) (this.d + var10), 0.0D).a(1.0D, 1.0D).b(0, 0, 0, 0).d();
				var6.b((double) this.f, (double) this.d, 0.0D).a(1.0D, 0.0D).b(0, 0, 0, 255).d();
				var6.b((double) this.g, (double) this.d, 0.0D).a(0.0D, 0.0D).b(0, 0, 0, 255).d();
				var5.b();
				var6.a(7, bms.i);
				var6.b((double) this.g, (double) this.e, 0.0D).a(0.0D, 1.0D).b(0, 0, 0, 255).d();
				var6.b((double) this.f, (double) this.e, 0.0D).a(1.0D, 1.0D).b(0, 0, 0, 255).d();
				var6.b((double) this.f, (double) (this.e - var10), 0.0D).a(1.0D, 0.0D).b(0, 0, 0, 0).d();
				var6.b((double) this.g, (double) (this.e - var10), 0.0D).a(0.0D, 0.0D).b(0, 0, 0, 0).d();
				var5.b();
			}
			if (var11 > 0) {
				...
				var6.a(7, bms.i);
				var6.b((double) var3, (double) this.e, 0.0D).a(0.0D, 1.0D).b(0, 0, 0, 255).d();
				var6.b((double) var4, (double) this.e, 0.0D).a(1.0D, 1.0D).b(0, 0, 0, 255).d();
				var6.b((double) var4, (double) this.d, 0.0D).a(1.0D, 0.0D).b(0, 0, 0, 255).d();
				var6.b((double) var3, (double) this.d, 0.0D).a(0.0D, 0.0D).b(0, 0, 0, 255).d();
				var5.b();
				var6.a(7, bms.i);
				var6.b((double) var3, (double) (var13 + var12), 0.0D).a(0.0D, 1.0D).b(128, 128, 128, 255).d();
				var6.b((double) var4, (double) (var13 + var12), 0.0D).a(1.0D, 1.0D).b(128, 128, 128, 255).d();
				var6.b((double) var4, (double) var13, 0.0D).a(1.0D, 0.0D).b(128, 128, 128, 255).d();
				var6.b((double) var3, (double) var13, 0.0D).a(0.0D, 0.0D).b(128, 128, 128, 255).d();
				var5.b();
				var6.a(7, bms.i);
				var6.b((double) var3, (double) (var13 + var12 - 1), 0.0D).a(0.0D, 1.0D).b(192, 192, 192, 255).d();
				var6.b((double) (var4 - 1), (double) (var13 + var12 - 1), 0.0D).a(1.0D, 1.0D).b(192, 192, 192, 255).d();
				var6.b((double) (var4 - 1), (double) var13, 0.0D).a(1.0D, 0.0D).b(192, 192, 192, 255).d();
				var6.b((double) var3, (double) var13, 0.0D).a(0.0D, 0.0D).b(192, 192, 192, 255).d();
				var5.b();
			}
		...
		for (int rowIndex = 0; rowIndex < heightMap.size(); ++rowIndex) {
			...
			if ((newY > getBottom()) || (newY + slotHeight < getTop())) {
				...
				if (isDrawSelection() && (isSelected(rowIndex))) {
					...
					bfl.x();
					localciv.a(7, bms.i);
					localciv.b((double) x1, (double) (newY + slotHeight + 2), 0.0D).a(0.0D, 1.0D).b(128, 128, 128, 255).d();
					localciv.b((double) x2, (double) (newY + slotHeight + 2), 0.0D).a(1.0D, 1.0D).b(128, 128, 128, 255).d();
					localciv.b((double) x2, (double) (newY - 2), 0.0D).a(1.0D, 0.0D).b(128, 128, 128, 255).d();
					localciv.b((double) x1, (double) (newY - 2), 0.0D).a(0.0D, 0.0D).b(128, 128, 128, 255).d();
					localciv.b((double) (x1 + 1), (double) (newY + slotHeight + 1), 0.0D).a(0.0D, 1.0D).b(0, 0, 0, 255).d();
					localciv.b((double) (x2 - 1), (double) (newY + slotHeight + 1), 0.0D).a(1.0D, 1.0D).b(0, 0, 0, 255).d();
					localciv.b((double) (x2 - 1), (double) (newY - 1), 0.0D).a(1.0D, 0.0D).b(0, 0, 0, 255).d();
					localciv.b((double) (x1 + 1), (double) (newY - 1), 0.0D).a(0.0D, 0.0D).b(0, 0, 0, 255).d();
					localckx.b();
					bfl.w();
				}
	...
	protected void a(int x, int y, bfx tesselator) {
		if (header != null) {
