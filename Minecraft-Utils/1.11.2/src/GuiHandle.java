...
public class GuiHandle extends bho implements IGuiHandle {
	...
	public static void drawRect(double left, double top, double right, double bottom, int color) {
		...
		bqs worldRenderer = bqs.a();
		bpy tesselator = worldRenderer.c();
		GLUtil.enableBlend();
		bqg.z();
		GLUtil.tryBlendFuncSeparate(770, 771, 1, 0);
		GLUtil.color(b, g, r, a);
		tesselator.a(7, bzh.e);
