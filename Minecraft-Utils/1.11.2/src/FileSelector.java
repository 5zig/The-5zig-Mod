...
public class FileSelector implements IFileSelector {
	...
	public void draw(int mouseX, int mouseY, float partialTicks) {
		...
		GLUtil.disableFog();
		bqs tessellator = bqs.a();
		bpy worldRenderer = tessellator.c();
		...
		if (var11 > 0) {
			...
			var12 = ot.a(var12, 32, bottom - top - 8);
	...
	protected void bindAmountScrolled() {
		amountScrolled = ot.a(amountScrolled, 0.0F, (float) this.m());
	}
			...
			if (initialClickY == -1) {
				...
				if (mouseY >= top && mouseY <= bottom) {
					...
					if (mouseX >= scrollBarX0 && mouseX <= scrollBarX1) {
						...
						var8 = ot.a(var8, 32, bottom - top - 8);
