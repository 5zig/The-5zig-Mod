...
public class FaceBakery {
	...
	public static final class Constants {
		public static final int SOUTH = cv.d.a();
		public static final int UP = cv.b.a();
		public static final int EAST = cv.f.a();
		public static final int NORTH = cv.c.a();
		public static final int DOWN = cv.a.a();
		public static final int WEST = cv.e.a();
	}

	public FaceBakery() {
	}

	public brd a(Vector3f vector1, Vector3f vector2, brf blockPartFace, cv enumFacing, cbi modelRotation, brg blockPartRotation, boolean b1, boolean b2) {
		...
		return new brd(data, blockPartFace.c, facing, null);
	}
	...
	private int[] a(brf blockPartFace, cv enumFacing, float[] vec, cbi modelRotation, brg blockPartRotation, boolean b1, boolean b2) {
		int[] data = new int[28];
	...
	private int a(cv var) {
		float var1 = this.b(var);
		int var2 = ot.a((int) (var1 * 255.0F), 0, 255);
		return -16777216 | var2 << 16 | var2 << 8 | var2;
	}

	private float b(cv enumFacing) {
		switch (enumFacing) {
			case a:
				return 0.5F;
			case b:
	...
	private float[] a(Vector3f var, Vector3f var1) {
		float[] var2 = new float[cv.values().length];
	...
	private void a(int[] dataIn, int count, cv enumFacing, brf blockPartFace, float[] vec, cbi modelRotation, brg blockPartRotation, boolean b1, boolean b2) {
		cv var10 = modelRotation.a(enumFacing);
		int var11 = b2 ? this.a(var10) : -1;
		bqd.b var12 = bqd.a(enumFacing).a(count);
	...
	private void a(int[] dataIn, int var1, int count, Vector3f var3, int var4, brh blockPartFace) {
		int var7 = var1 * 7;
	...
	public int a(Vector3f var, cv var1, int var2, cbi var3, boolean var4) {
		if (var3 == cbi.a) {
			return var2;
		} else {
	...
	public void a(int[] data, cv facing, brh var) {
		for (int i = 0; i < 4; ++i) {
	...
	private void a(int[] var, cv var1) {
		int[] var2 = new int[var.length];
		System.arraycopy(var, 0, var2, 0, var.length);
		float[] var3 = new float[cv.values().length];
		...
		bqd var17 = bqd.a(var1);

		for (var5 = 0; var5 < 4; ++var5) {
			int var18 = 7 * var5;
			bqd.b var19 = var17.a(var5);
			var8 = var3[var19.a];
			...
			for (int var11 = 0; var11 < 4; ++var11) {
				...
				if (ot.a(var8, var13) && ot.a(var9, var14) && ot.a(var10, var15)) {
	...
	private void a(int count, int[] data, cv enumFacing, brh blockPartFace) {
		int var5 = 7 * count;
		...
		if (var6 < -0.1F || var6 >= 1.1F) {
			var6 -= (float) ot.d(var6);
		}

		if (var7 < -0.1F || var7 >= 1.1F) {
			var7 -= (float) ot.d(var7);
		}

		if (var8 < -0.1F || var8 >= 1.1F) {
			var8 -= (float) ot.d(var8);
		}
