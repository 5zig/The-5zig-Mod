...
public class GuiList<E extends Row> extends bgd implements IGuiList<E> {
	...
	public void a(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.q) {
			...
			bqg.g();
			bqg.p();
			bqs tesselator = bqs.a();
			bpy worldRenderer = tesselator.c();
			...
			if (backgroundTexture != null) {
				...
				MinecraftFactory.getVars().bindTexture(bfh.b);
				float var7 = 32.0F;
				worldRenderer.a(7, bzh.i);
	...
	protected void a(int x, int y, bqs tesselator) {
		if (header != null) {
