...
public class GuiHandle extends bhm implements IGuiHandle {
	...
	public static void drawRect(double left, double top, double right, double bottom, int color) {
		...
		bqq worldRenderer = bqq.a();
		bpw tesselator = worldRenderer.c();
		GLUtil.enableBlend();
		bqe.z();
		GLUtil.tryBlendFuncSeparate(770, 771, 1, 0);
		GLUtil.color(b, g, r, a);
		tesselator.a(7, bze.e);
