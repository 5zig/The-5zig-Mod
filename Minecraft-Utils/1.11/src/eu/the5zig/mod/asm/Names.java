...
public class Names {
	...
	public static Name minecraft = new Name("beq");
	...
	public static Name guiMainMenu = new Name("bht");
	public static Name guiButton = new Name("bfk", "(IIILjava/lang/String;)V");
	public static Name guiButtonExtended = new Name(guiButton.getName(), "(IIIIILjava/lang/String;)V");
	public static Name fontRenderer = new Name("bfe");
	public static Name guiTextfield = new Name("bfo", "(IL" + fontRenderer.getName() + ";IIII)V");
	...
	public static Name guiIngame = new Name("bff");
	...
	public static Name scaledResolution = new Name("bfi");
	...
	public static Name guiIngameMenu = new Name("bhi");

	public static Name glStateManager = new Name("bqe");
	public static Name glColor = new Name("c", "(FFFF)V");

	public static Name guiAchievement = new Name("bhw");
	public static Name updateAchievementWindow = new Name("a", "()V");

	public static Name guiChat = new Name("bgp");
	public static Name guiChatNew = new Name("bfl");
	...
	public static Name guiChatLine = new Name("bem");
	public static Name drawChat = new Name("a", "(I)V");
	public static Name clearChat = new Name("a", "()V");

	public static Name gameSettings = new Name("bes");
	...
	public static Name netHandlerPlayClient = new Name("bnm");
	...
	public static Name itemStack = new Name("afi");
	public static Name openContainer = new Name("ack");
	...
	public static Name guiGameOver = new Name("bgx");
	public static Name guiGameOverInit = new Name("<init>", "(L" + chatComponent.getName() + ";)V");

	public static Name guiScreen = new Name("bhm");
	...
	public static Name guiOptions = new Name("bhg");

	public static Name serverData = new Name("bnr");
	public static Name guiConnecting = new Name("bgt");
	...
	public static Name guiDisconnected = new Name("bha");
	public static Name guiDisconnectedInit = new Name("<init>", "(L" + guiScreen.getName() + ";Ljava/lang/String;L" + chatComponent.getName() + ";)V");

	public static Name abstractClientPlayer = new Name("bpn");
	public static Name abstractClientPlayerInit = new Name("<init>", "(Lajq;Lcom/mojang/authlib/GameProfile;)V");
	...
	public static Name entityPlayerSP = new Name("bpq");
	public static Name sendChatMessage = new Name("g", "(Ljava/lang/String;)V");

	public static Name guiMultiplayer = new Name("bjd");
	public static Name serverSelectionList = new Name("bjh");

	public static Name guiResourcePacks = new Name("bjk");

	public static Name guiSelectWorld = new Name("bjy");
	public static Name worldList = new Name("bka");

	public static Name renderItem = new Name("bve");
	public static Name renderItemPerson = new Name("a", "(L" + itemStack.getName() + ";Lsv;Lbro$b;Z)V");
	public static Name renderItemInventory = new Name("a", "(L" + itemStack.getName() + ";IILcbe;)V");

	public static Name guiEditSign = new Name("biz");
	public static Name tileSign = new Name("ast");

	public static Name rendererLivingEntity = new Name("bvi");
	public static Name canRenderName = new Name("a", "(Lsv;)Z");
