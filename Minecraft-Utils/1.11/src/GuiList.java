...
public class GuiList<E extends Row> extends bgb implements IGuiList<E> {
	...
	public void a(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.q) {
			...
			bqe.g();
			bqe.p();
			bqq tesselator = bqq.a();
			bpw worldRenderer = tesselator.c();
			...
			if (backgroundTexture != null) {
				...
				MinecraftFactory.getVars().bindTexture(bff.b);
				float var7 = 32.0F;
				worldRenderer.a(7, bze.i);
			...
			if (var11 > 0) {
				...
				var12 = ot.a(var12, 32, this.e - this.d - 8);
	...
	protected void a(int x, int y, bqq tesselator) {
		if (header != null) {
