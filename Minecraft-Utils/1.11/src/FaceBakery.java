...
public class FaceBakery {
	...
	public brb a(Vector3f vector1, Vector3f vector2, brd blockPartFace, cv enumFacing, cbf modelRotation, bre blockPartRotation, boolean b1, boolean b2) {
		...
		return new brb(data, blockPartFace.c, facing, null);
	}
	...
	private int[] a(brd blockPartFace, cv enumFacing, float[] vec, cbf modelRotation, bre blockPartRotation, boolean b1, boolean b2) {
		int[] data = new int[28];
	...
	private void a(int[] dataIn, int var1, int count, Vector3f var3, int var4, brf blockPartFace) {
		int var7 = var1 * 7;
	...
	public int a(Vector3f var, cv var1, int var2, cbf var3, boolean var4) {
		if (var3 == cbf.a) {
			return var2;
		} else {
	...
	public void a(int[] data, cv facing, brf var) {
		for (int i = 0; i < 4; ++i) {
	...
	private void a(int[] var, cv var1) {
		...
		bqb var17 = bqb.a(var1);

		for (var5 = 0; var5 < 4; ++var5) {
			int var18 = 7 * var5;
			bqb.b var19 = var17.a(var5);
			var8 = var3[var19.a];
	...
	private void a(int count, int[] data, cv enumFacing, brf blockPartFace) {
		int var5 = 7 * count;
