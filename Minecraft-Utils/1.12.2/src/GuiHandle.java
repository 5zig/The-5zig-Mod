...
public class GuiHandle extends blk implements IGuiHandle {
	...
	public static void drawRect(double left, double top, double right, double bottom, int color) {
		...
		bve worldRenderer = bve.a();
		buk tesselator = worldRenderer.c();
		GLUtil.enableBlend();
		bus.z();
		GLUtil.tryBlendFuncSeparate(770, 771, 1, 0);
		GLUtil.color(b, g, r, a);
		tesselator.a(7, cdy.e);
