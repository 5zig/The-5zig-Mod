...
public class GuiList<E extends Row> extends bjr implements IGuiList<E> {
	...
	public void a(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.q) {
			...
			bus.g();
			bus.p();
			bve tesselator = bve.a();
			buk worldRenderer = tesselator.c();
			...
			if (backgroundTexture != null) {
				...
				MinecraftFactory.getVars().bindTexture(biq.b);
				float var7 = 32.0F;
				worldRenderer.a(7, cdy.i);
			...
			if (var11 > 0) {
				...
				var12 = rk.a(var12, 32, this.e - this.d - 8);
	...
	@Override
	protected void a(int x, int y, bve tesselator) {
		if (header != null) {
