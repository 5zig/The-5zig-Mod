...
public class PatchRendererLivingEntity implements IClassTransformer {
	...
	public class PatchCanRenderName extends MethodVisitor {
		...
		public void visitCode() {
			...
			mv.visitMethodInsn(INVOKESTATIC, Names.minecraft.getName(), "B", "()L" + Names.minecraft.getName() + ";", false);
			mv.visitFieldInsn(GETFIELD, Names.minecraft.getName(), "h", "L" + Names.entityClientPlayerMP.getName() + ";");
