...
public class FaceBakery {
	...
	public bvn a(Vector3f vector1, Vector3f vector2, bvp blockPartFace, fa enumFacing, cfx modelRotation, bvq blockPartRotation, boolean b1, boolean b2) {
		...
		return new bvn(data, blockPartFace.c, facing, null);
	}
	...
	private int[] a(bvp blockPartFace, fa enumFacing, float[] vec, cfx modelRotation, bvq blockPartRotation, boolean b1, boolean b2) {
		int[] data = new int[28];
	...
	private int a(fa var) {
		...
		int var2 = ri.a((int) (var1 * 255.0F), 0, 255);
	...
	private void a(int[] dataIn, int count, fa enumFacing, bvp blockPartFace, float[] vec, cfx modelRotation, bvq blockPartRotation, boolean b1, boolean b2) {
		fa var10 = modelRotation.a(enumFacing);
		int var11 = b2 ? this.a(var10) : -1;
		bun.b var12 = bun.a(enumFacing).a(count);
	...
	private void a(int[] dataIn, int var1, int count, Vector3f var3, int var4, bvr blockPartFace) {
		int var7 = var1 * 7;
	...
	public int a(Vector3f var, fa var1, int var2, cfx var3, boolean var4) {
		if (var3 == cfx.a) {
			return var2;
		} else {
	...
	public void a(int[] data, fa facing, bvr var) {
		for (int i = 0; i < 4; ++i) {
	...
	private void a(int[] var, fa var1) {
		...
		bun var17 = bun.a(var1);

		for (var5 = 0; var5 < 4; ++var5) {
			int var18 = 7 * var5;
			bun.b var19 = var17.a(var5);
			var8 = var3[var19.a];
			...
			for (int var11 = 0; var11 < 4; ++var11) {
				...
				if (ri.a(var8, var13) && ri.a(var9, var14) && ri.a(var10, var15)) {
	...
	private void a(int count, int[] data, fa enumFacing, bvr blockPartFace) {
		int var5 = 7 * count;
		...
		if (var6 < -0.1F || var6 >= 1.1F) {
			var6 -= (float) ri.d(var6);
		}

		if (var7 < -0.1F || var7 >= 1.1F) {
			var7 -= (float) ri.d(var7);
		}

		if (var8 < -0.1F || var8 >= 1.1F) {
			var8 -= (float) ri.d(var8);
		}
