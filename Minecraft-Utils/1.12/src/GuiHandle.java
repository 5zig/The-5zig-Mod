...
public class GuiHandle extends bli implements IGuiHandle {
	...
	public static void drawRect(double left, double top, double right, double bottom, int color) {
		...
		bvc worldRenderer = bvc.a();
		bui tesselator = worldRenderer.c();
		GLUtil.enableBlend();
		buq.z();
		GLUtil.tryBlendFuncSeparate(770, 771, 1, 0);
		GLUtil.color(b, g, r, a);
		tesselator.a(7, cdw.e);
