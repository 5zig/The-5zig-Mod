...
public class FaceBakery {
	...
	public static final class Constants {
		public static final int SOUTH = ct.d.a();
		public static final int UP = ct.b.a();
		public static final int EAST = ct.f.a();
		public static final int NORTH = ct.c.a();
		public static final int DOWN = ct.a.a();
		public static final int WEST = ct.e.a();
	}

	public FaceBakery() {
	}

	public boy a(Vector3f vector1, Vector3f vector2, bpa blockPartFace, ct enumFacing, bym modelRotation, bpb blockPartRotation, boolean b1, boolean b2) {
		...
		return new boy(data, blockPartFace.c, facing, null);
	}
	...
	private int[] a(bpa blockPartFace, ct enumFacing, float[] vec, bym modelRotation, bpb blockPartRotation, boolean b1, boolean b2) {
		int[] data = new int[28];
	...
	private int a(ct var) {
		float var1 = this.b(var);
		int var2 = op.a((int) (var1 * 255.0F), 0, 255);
		return -16777216 | var2 << 16 | var2 << 8 | var2;
	}

	private float b(ct enumFacing) {
		switch (enumFacing) {
			case a:
				return 0.5F;
			case b:
	...
	private float[] a(Vector3f var, Vector3f var1) {
		float[] var2 = new float[ct.values().length];
	...
	private void a(int[] dataIn, int var1, int count, Vector3f var3, int var4, bpc blockPartFace) {
		int var7 = var1 * 7;
	...
	public int a(Vector3f var, ct var1, int var2, bym var3, boolean var4) {
		if (var3 == bym.a) {
			return var2;
		} else {
	...
	public void a(int[] data, ct facing, bpc var) {
		for (int i = 0; i < 4; ++i) {
	...
	private void a(int[] var, ct var1) {
		int[] var2 = new int[var.length];
		System.arraycopy(var, 0, var2, 0, var.length);
		float[] var3 = new float[ct.values().length];
		...
		bny var17 = bny.a(var1);

		for (var5 = 0; var5 < 4; ++var5) {
			int var18 = 7 * var5;
			bny.b var19 = var17.a(var5);
			var8 = var3[var19.a];
			...
			for (int var11 = 0; var11 < 4; ++var11) {
				...
				if (op.a(var8, var13) && op.a(var9, var14) && op.a(var10, var15)) {
	...
	private void a(int count, int[] data, ct enumFacing, bpc blockPartFace) {
		int var5 = 7 * count;
		...
		if (var6 < -0.1F || var6 >= 1.1F) {
			var6 -= (float) op.d(var6);
		}

		if (var7 < -0.1F || var7 >= 1.1F) {
			var7 -= (float) op.d(var7);
		}

		if (var8 < -0.1F || var8 >= 1.1F) {
			var8 -= (float) op.d(var8);
		}
