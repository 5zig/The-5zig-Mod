...
public class SimpleTickingTexture extends bwa implements bwj {
		...
		if (!this.textureUploaded) {
			if (this.frames != null) {
				...
				for (int i = 0; i < bufferedImages1.size(); i++) {
					...
					bwg texture = ((Variables) MinecraftFactory.getVars()).getTextureManager().b(resourceLocation);
	...
	@Override
	public void a(bxd resourceManager) throws IOException {
	}
