...
public class GuiList<E extends Row> extends bei implements IGuiList<E> {
	...
	public void a(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.q) {
			...
			bnt worldRenderer = tesselator.c();
			...
			if (backgroundTexture != null) {
				...
				MinecraftFactory.getVars().bindTexture(bdm.b);
				float var7 = 32.0F;
				worldRenderer.a(7, bwm.i);
			...
			if (var11 > 0) {
				...
				var12 = op.a(var12, 32, this.e - this.d - 8);
	...
	protected void a(int x, int y, bon tesselator) {
		if (header != null) {
