...
public class Overlay extends bgd implements IOverlay {
	...
	private void updateScale() {
		...
		bdp scaledResolution = new bdp(this.mc);
		this.width = scaledResolution.a();
		this.height = scaledResolution.b();
		GLUtil.clear(256);
		GLUtil.matrixMode(GL11.GL_PROJECTION);
		GLUtil.loadIdentity();
		bob.a(0.0D, (double) this.width, (double) this.height, 0.0D, 1000.0D, 3000.0D);
		GLUtil.matrixMode(GL11.GL_MODELVIEW);
		GLUtil.loadIdentity();
