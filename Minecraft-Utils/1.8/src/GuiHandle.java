...
public class GuiHandle extends bxf implements IGuiHandle {
	...
	public static void drawRect(double left, double top, double right, double bottom, int color) {
		...
		ckx worldRenderer = ckx.a();
		civ tesselator = worldRenderer.c();
		GLUtil.enableBlend();
		cjm.x();
		GLUtil.tryBlendFuncSeparate(770, 771, 1, 0);
		GLUtil.color(b, g, r, a);
		tesselator.b();
		tesselator.b(left, bottom, 0.0D);
		tesselator.b(right, bottom, 0.0D);
		tesselator.b(right, top, 0.0D);
		tesselator.b(left, top, 0.0D);
		worldRenderer.b();
		cjm.w();
		GLUtil.disableBlend();
	}
	...
	public static void drawGradientRect(double left, double top, double right, double bottom, int startColor, int endColor, boolean vertical) {
		...
		if (!vertical) {
			...
			tesselator.b(right, top, 1.0);
			tesselator.b(left, top, 1.0);
