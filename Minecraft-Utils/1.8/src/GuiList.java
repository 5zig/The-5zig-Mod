...
public class GuiList<E extends Row> extends bvk implements IGuiList<E> {
	...
	public void a(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.q) {
			...
			if (backgroundTexture != null) {
				...
				var6.b();
				var6.c(2105376);
				var6.a((double) this.g, (double) this.e, 0.0D, (double) ((float) this.g / var8), (double) ((float) (this.e + (int) this.n) / var8));
				var6.a((double) this.f, (double) this.e, 0.0D, (double) ((float) this.f / var8), (double) ((float) (this.e + (int) this.n) / var8));
				var6.a((double) this.f, (double) this.d, 0.0D, (double) ((float) this.f / var8), (double) ((float) (this.d + (int) this.n) / var8));
				var6.a((double) this.g, (double) this.d, 0.0D, (double) ((float) this.g / var8), (double) ((float) (this.d + (int) this.n) / var8));
				var5.b();
			}
			...
			if (drawDefaultBackground || MinecraftFactory.getVars().isPlayerNull() || var11 > 0) {
				var6.b();
				var6.a(0, 0);
				var6.a((double) getLeft(), (double) (getTop() + var10), 0.0D, 0.0D, 1.0D);
				var6.a((double) getRight(), (double) (getTop() + var10), 0.0D, 1.0D, 1.0D);
				var6.a(0, 255);
				var6.a((double) getRight(), getTop(), 0.0D, 1.0D, 0.0D);
				var6.a((double) getLeft(), getTop(), 0.0D, 0.0D, 0.0D);
				var5.b();

				var6.b();
				var6.a(0, 255);
				var6.a((double) getLeft(), (double) getBottom(), 0.0D, 0.0D, 1.0D);
				var6.a((double) getRight(), (double) getBottom(), 0.0D, 1.0D, 1.0D);
				var6.a(0, 0);
				var6.a((double) getRight(), (double) getBottom() - var10, 0.0D, 1.0D, 0.0D);
				var6.a((double) getLeft(), (double) getBottom() - var10, 0.0D, 0.0D, 0.0D);
				var5.b();
			}
			if (var11 > 0) {
				int var12 = (this.e - this.d) * (this.e - this.d) / this.k();
				var12 = uv.a(var12, 32, this.e - this.d - 8);
				...
				var6.b();
				var6.a(0, 255);
				var6.a((double) var3, (double) this.e, 0.0D, 0.0D, 1.0D);
				var6.a((double) var4, (double) this.e, 0.0D, 1.0D, 1.0D);
				var6.a((double) var4, (double) this.d, 0.0D, 1.0D, 0.0D);
				var6.a((double) var3, (double) this.d, 0.0D, 0.0D, 0.0D);
				var5.b();
				var6.b();
				var6.a(8421504, 255);
				var6.a((double) var3, (double) (var13 + var12), 0.0D, 0.0D, 1.0D);
				var6.a((double) var4, (double) (var13 + var12), 0.0D, 1.0D, 1.0D);
				var6.a((double) var4, (double) var13, 0.0D, 1.0D, 0.0D);
				var6.a((double) var3, (double) var13, 0.0D, 0.0D, 0.0D);
				var5.b();
				var6.b();
				var6.a(12632256, 255);
				var6.a((double) var3, (double) (var13 + var12 - 1), 0.0D, 0.0D, 1.0D);
				var6.a((double) (var4 - 1), (double) (var13 + var12 - 1), 0.0D, 1.0D, 1.0D);
				var6.a((double) (var4 - 1), (double) var13, 0.0D, 1.0D, 0.0D);
				var6.a((double) var3, (double) var13, 0.0D, 0.0D, 0.0D);
				var5.b();
			}
		...
		for (int rowIndex = 0; rowIndex < heightMap.size(); ++rowIndex) {
			...
			if ((newY > getBottom()) || (newY + slotHeight < getTop())) {
				...
				if (isDrawSelection() && (isSelected(rowIndex))) {
					...
					localciv.b();
					localciv.c(8421504);
					localciv.a(x1, newY + slotHeight + 2, 0.0D, 0.0D, 1.0D);
					localciv.a(x2, newY + slotHeight + 2, 0.0D, 1.0D, 1.0D);
					localciv.a(x2, newY - 2, 0.0D, 1.0D, 0.0D);
					localciv.a(x1, newY - 2, 0.0D, 0.0D, 0.0D);

					localciv.c(0);
					localciv.a(x1 + 1, newY + slotHeight + 1, 0.0D, 0.0D, 1.0D);
					localciv.a(x2 - 1, newY + slotHeight + 1, 0.0D, 1.0D, 1.0D);
					localciv.a(x2 - 1, newY - 1, 0.0D, 1.0D, 0.0D);
					localciv.a(x1 + 1, newY - 1, 0.0D, 0.0D, 0.0D);
	...
	public int getContentHeight() {
		int height = bottomPadding + (getHeaderPadding() > 0 ? getHeaderPadding() + 8 : getHeaderPadding());
	...
	protected void a(int x, int y, ckx tesselator) {
		if (header != null) {
