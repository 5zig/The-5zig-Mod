 ...
 */
public class Textfield extends bul implements ITextfield {
	 ...
	 * @param maxStringLength The Max Length the Text of the Textfield can hbsu.
	 */
	...
	/**
	 * Gets the max String Length the Text of the Textfield can hbsu.
	 *
	 * @return the max String Length the Text of the Textfield can hbsu.
	 */
	...
	/**
	 * Sets the max String Length the Text of the Textfield can hbsu.
	 *
