    ...
    public class ClassPatcher extends ClassVisitor {
        ...
        public void visitEnd() {
            ...
            if (!patchedKeyPressedMethod) {
                ...
                mv.visitMethodInsn(INVOKESTATIC, "BytecodeHook", "onGuiMultiplayerKey", "(III)V", false);
                Label l1 = new Label();
                mv.visitLabel(l1);
            ...
            if (!patchedMouseClickedMethod) {
                ...
                mv.visitMethodInsn(INVOKESTATIC, "BytecodeHook", "onGuiMultiplayerMouseClicked", "(DDI)V", false);
                mv.visitVarInsn(ALOAD, 0);
                mv.visitVarInsn(DLOAD, 1);
                mv.visitVarInsn(DLOAD, 3);
                mv.visitVarInsn(ILOAD, 5);
