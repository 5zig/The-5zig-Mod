    ...
    public class ClassPatcher extends ClassVisitor {
        ...
        public void visitEnd() {
            ...
            if (!patchedKeyPressedMethod) {
                ...
                mv.visitMethodInsn(INVOKESTATIC, "BytecodeHook", "onGuiSelectWorldKey", "(III)V", false);
                Label l1 = new Label();
                mv.visitLabel(l1);
            ...
            if (!patchedMouseClickedMethod) {
                ...
                mv.visitMethodInsn(INVOKESTATIC, "BytecodeHook", "onGuiSelectWorldMouseClicked", "(DDI)V", false);
                mv.visitVarInsn(ALOAD, 0);
                mv.visitVarInsn(DLOAD, 1);
                mv.visitVarInsn(DLOAD, 3);
                mv.visitVarInsn(ILOAD, 5);
    ...
    public class PatchInitGui extends MethodVisitor {
        ...
        public void visitInsn(int opcode) {
            if (opcode == RETURN) {
                ...
                mv.visitVarInsn(ALOAD, 0);
                mv.visitVarInsn(ALOAD, 0);
                mv.visitFieldInsn(GETFIELD, Names.guiSelectWorld.getName(), Names.worldListField.getName(), "L" + Names.worldList.getName() + ";");
