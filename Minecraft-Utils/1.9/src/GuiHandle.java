...
public class GuiHandle extends bfb implements IGuiHandle {
	...
	public static void drawRect(double left, double top, double right, double bottom, int color) {
		...
		bnu worldRenderer = bnu.a();
		bmz tesselator = worldRenderer.c();
		GLUtil.enableBlend();
		bni.z();
		GLUtil.tryBlendFuncSeparate(770, 771, 1, 0);
		GLUtil.color(b, g, r, a);
		tesselator.a(7, bvp.e);
