...
public abstract class Gui {
	...
	static {
		try {
			...
			drawModalRectWithCustomSizedTexture = handleClass.getMethod("drawModalRectWithCustomSizedTexture", int.class, int.class, float.class, float.class, int.class, int.class, float
					.class, float.class);
	...
	public void addTextField(ITextfield textfield) {
		...
		textFieldIdLookup.put(textfield.getId(), textfield);
	}

	public void removeTextField(ITextfield textfield) {
		textfields.remove(textfield);
		textFieldIdLookup.remove(textfield.getId());
	}
	...
	public void drawTexturedModalRect(int x, int y, int texX, int texY, int width, int height) {
		handle.drawTexturedModalRect(x, y, texX, texY, width, height);
	}

	public void drawHoveringText(List<String> lines, int x, int y) {
		handle.drawHoveringText(lines, x, y);
	}
