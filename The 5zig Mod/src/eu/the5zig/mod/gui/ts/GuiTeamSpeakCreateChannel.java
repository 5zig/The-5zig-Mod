...
public abstract class GuiTeamSpeakCreateChannel extends Gui {
	...
	public void initGui() {
		...
		textfieldName.setText(channelName == null ? "" : channelName);
		...
		textfieldPassword.setText(channelPassword == null ? "" : channelPassword);
		...
		textfieldTopic.setText(channelTopic == null ? "" : channelTopic);
		...
		textfieldDescription.setText(channelDescription == null ? "" : channelDescription);
		...
		getTextfieldById(107).setText(String.valueOf(neededTalkPower));
		addTextField(The5zigMod.getVars().createTextfield(108, getWidth() / 2 + 110, getHeight() / 6 - 12 + 16 * 4 + 80, 50, 14, 15));
		getTextfieldById(108).setText(String.valueOf(maxClients));
	}
	...
	protected void actionPerformed(IButton button) {
		if (button.getId() == 100) {
			...
			int neededTalkPower = Utils.parseInt(getTextfieldById(107).getText());
			int maxClients = Utils.parseInt(getTextfieldById(108).getText());
	...
	protected void tick() {
		...
		getButtonById(100).setEnabled(!getTextfieldById(100).getText().isEmpty());
		getButtonById(106).setEnabled(!orderBottom.isSelected());

		channelName = getTextfieldById(100).getText();
		channelPassword = getTextfieldById(101).getText();
		channelTopic = getTextfieldById(102).getText();
		channelDescription = getTextfieldById(103).getText();
		channelLifespanIndex = channelLifespan.getSelectedIndex();
		defaultChannelBool = defaultChannel.isSelected();
		neededTalkPower = Utils.parseInt(getTextfieldById(107).getText());
		maxClients = Utils.parseInt(getTextfieldById(108).getText());
