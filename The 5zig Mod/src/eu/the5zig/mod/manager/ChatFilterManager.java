...
public class ChatFilterManager {
	...
	public void onTick(TickEvent event) {
		...
		if (The5zigMod.getKeybindingManager().toggleChatFilter.isPressed()) {
			enabled = !enabled;
			if (enabled) {
				...
				The5zigMod.getVars().messagePlayer(ChatColor.RED + I18n.translate("chat_filter.message.disabled",
						The5zigMod.getVars().getKeyDisplayStringShort(The5zigMod.getKeybindingManager().toggleChatFilter.getKeyCode())));
