...
public class Leggings extends ItemStackItem {
	...
	protected ItemStack getStack(boolean dummy) {
		return dummy ? The5zigMod.getVars().getItemByName("minecraft:iron_leggings") : The5zigMod.getVars().getItemInArmorSlot(1);
	}
}
